    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen pb-32">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex items-center gap-1 mt-1 text-slate-500 dark:text-slate-400">
                                ...
                                <span className="text-[10px]">0.2 mi</span>
                            </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex items-center gap-1 mt-1 text-slate-500 dark:text-slate-400">
                                <span className="material-icons-round text-[12px]">location_on</span>
                                <span className="text-[10px]">0.5 mi</span>
                            </div>
                            <div className="flex items-center gap-1 mt-2 text-yellow-500">
                                <span className="material-icons-round text-xs">star</span>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex items-center gap-1 mt-1 text-slate-500 dark:text-slate-400">
                                <span className="material-icons-round text-[12px]">location_on</span>
                                <span className="text-[10px]">0.8 mi</span>
                            </div>
                            <div className="flex items-center gap-1 mt-2 text-yellow-500">
                                <span className="material-icons-round text-xs">star</span>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm border border-slate-100 dark:border-slate-700">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex items-center gap-1 mt-1 text-slate-500 dark:text-slate-400">
                                <span className="material-icons-round text-[12px]">location_on</span>
                                <span className="text-[10px]">1.2 mi</span>
                            </div>
                            <div className="flex items-center gap-1 mt-2 text-yellow-500">
                                <span className="material-icons-round text-xs">star</span>
            ...
            <div className="fixed bottom-8 left-0 right-0 px-6 z-50">
                <nav className="glass-nav rounded-2xl px-4 py-3 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] flex justify-between items-center max-w-sm mx-auto">
                    <Link href="/" className="flex flex-col items-center gap-1 text-primary px-2">
                        <span className="material-icons-round text-2xl">home</span>
                        <span className="text-[10px] font-bold">Home</span>
                    </Link>
                    <Link href="/discover" className="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 px-2">
                        <span className="material-icons-round text-2xl">explore</span>
                        <span className="text-[10px] font-medium">Explore</span>
                    </Link>
                    <button className="bg-primary hover:bg-blue-600 text-white px-4 py-2.5 rounded-xl flex items-center gap-2 shadow-lg shadow-primary/20 transition-all active:scale-95">
                        <span className="material-symbols-outlined text-lg">add_box</span>
                        <span className="text-xs font-bold uppercase tracking-wider">Post</span>
                    </button>
                    <Link href="#" className="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 px-2">
                        <span className="material-icons-round text-2xl">favorite</span>
                        <span className="text-[10px] font-medium">Saved</span>
                    </Link>
                    <Link href="/sign-in" className="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 px-2">
